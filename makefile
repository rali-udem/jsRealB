...
core := build/Constituent.js build/Phrase.js build/Terminal.js build/Dependent.js build/IO-json.js \
        build/Date.js build/Number.js build/Utils.js $(en) $(fr) build/Warnings.js

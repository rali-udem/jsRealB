...
* [`data`](data/):  lexicographic information that is bundled with the `dist/jsRealB.js`
    ...
    * `lexicon-en.jsonrnc, lexicon-fr.jsonrnc` : *jsonrnc* schema for validating language specific lexicon.
    * `lexicon-en.jsonrnc.json, lexicon-fr.jsonrnc.json` : JSON Schema files corresponding to the *jsonrnc* schemas. These files are generated by the validation process. 

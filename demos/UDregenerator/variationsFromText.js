...
function generate(conlluFile,conlluFileName){
    // UDregenerator execution
    const uds=parseUDs(conlluFile,conlluFileName);
        ...
        if (!existsSync(conlluFileName) || statSync(conlluFileName).mtime<statSync(fileName).mtime){
            ...
            child.on("exit",function(code,signal){
                if (code==0){
                    ...
                    generate(readFileSync(conlluFileName,{encoding:'utf8', flag:'r'}),conlluFileName)
                } else {

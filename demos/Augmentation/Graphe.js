...
var etats =[
    ...
    new Test( "Est-il dans son bureau ?",342,48,
              ...
              "Frapper","Guetter son retour dans le couloir",false),
    ...
    new Test( "des Œufs?",188,541,
              ...
              "Étaient-ils pourris ?","ATTENDRE/14H30",true),
    ...
    new Test( "L'obtenez-vous ?",85,955,
              ...
              "Vous donne-t-on des espérances","Vous donne-t-on des espérances",false),
    ...
    new Etape("Retournez à votre place",454,994,
              ()=>S(protagoniste.struct(),
                    VP(V("retourner").t(t),
                       PP(P("à"),poss(),N("place")))),
              "Réfléchissez au prochain problème"),

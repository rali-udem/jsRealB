...
var betonArme=np("béton").add(A("armé"));
var puits=np("puits").n("p");
var longrines=np("longrine").n("p");
var canalisations=np("canalisation").n("p");
var travail=tnp("construction","de","bâtiment");
...
addNPVP(tasks,"q",tnp(np("approvisionnement").n("p"),"pour","chauffage"),VP(Q("se"),V("approvisionner"),PP(P("pour"),NP(D("le"),N("chauffage")))));
...
addNPVP(tasks,"x",NP(D("le"),N("enduit")).n("p"),PP(CP(C("et"),V("remplir"),V("recouvrir")),P("de"),N("enduit").n("p")));

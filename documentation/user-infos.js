...
var sentType={"fr":'',"en":'',
    "ex": [
      ...
      {"pattern":".typ({maje:true})",
        "fr":["Pluriel de majesté",'S(Pro("moi").pe(2),VP(V("être"),AP(A("gentil"),\n PP(P("avec"),NP(D("mon").pe(2),N("soeur")))))).typ({maje:true})'],
        "en":["Majestic plural",'S(Pro("me").pe(1).c("nom"),\n  VP(V("love"),NP(D("my").pe(1).ow("s"),N("mouse")))).typ({maje:true})']},

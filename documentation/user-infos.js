...
var optionsSect=
     ...
     "ex":[
           ...
           {"pattern":'.t("bp-to")',"fr":["",''],
                                   "en":["past infinitive with 'to'",'V("love").t("bp-to")']},
           ...
           {"pattern":'.t("fa")', "fr":["futur antérieur",'V("aimer").t("fa")'],
                           "en":["",'']},
           {"pattern":'.t("pa")', "fr":["passé antérieur",'V("aimer").t("pa")'],
                           "en":["",'']},
...
"ex":[ 
       ...
       {"pattern":'.ba("[")', "fr":["entourer de crochets",'N("homme").ba("[")'],
                     "en":["Wrap within brackets",'N("man").ba("[")']},
       {"pattern":'.ba("*")', "fr":["entourer d'étoiles",'N("homme").ba("*")'],
                     "en":["Wrap within stars",'N("man").ba("*")']},
       {"pattern":'.ba("*").ba("(")', "fr":["entourer de plusieurs symboles",'N("homme").ba("*").ba("(")'],
                     "en":["Wrap within many symbols",'N("man").ba("*").ba("(")']},

       {"group":"","fr":'',"en":''},
       {"pattern":'.lier()', "fr":["lier le suivant par un trait d'union",'VP(V("lier").t("ip").pe(2).lier(),Pro("le"))'],
                     "en":["Combine next with a dash",'NP(NO(1).nat().lier(),P("of").lier(),D("a").lier(),N("kind"))']},
       ...
       {"group":".tag(…)","fr":"Balisage HTML","en":'HTML tag'},
       ...
       {"pattern":'', 
             "fr":["hyperlien",'N("joueur").tag("a",{"href":"http://example.com"})'],
             "en":["hyperlink",'N("player").tag("a",{"href":"http://example.com"})']},
       {"pattern":'', 
             "fr":["combinaison de balises",'N("maison").tag("b").tag("i")'],
             "en":["combining tags",'N("house").tag("b").tag("i")']},
       
      {"group":".md(…)","fr":"Balisage Markdown","en":'Markdown markup'},
      {"pattern":'.md("*"|"**")', 
             "fr":["italique gras",'N("joueur").md("***")'],
             "en":["italics bold",'N("player").md("***")']},
      {"pattern":'.md("@...")', 
             "fr":["hyperlien",'N("joueur").md("@http://example.com")'],
             "en":["hyperlink",'N("player").md("@http://example.com")']},
      {"pattern":'.md("#..")', 
             "fr":["niveau de titre",'N("maison").md("#")'],
             "en":["header level",'N("house").md("#")']},                     
]};

var nPmods={"fr":'',"en":'',
    "ex": [
        {"group":"","fr":"Placement de l'adjectif ou de l'adverbe (dépendant de la langue)",
            "en":"Adjective or adverb position (language dependent)"},
        {"pattern":"", "fr":["Adjectif: par défaut",'NP(D("le"),A("petit"),N("jouet"))'],
                           "en":["Adjective: by default",'NP(D("the"),A("small"),N("toy"))']},
        {"pattern":"", "fr":["Adjectif: par défaut",'NP(D("le"),A("bleu"),N("jouet"))'],
                        "en":["Adjective: by default",'NP(D("the"),N("toy"),A("blue"))']},
        {"pattern":"", "fr":["Adverbe: par défaut",'VP(V("aller"),Adv("bien")).t("pc")'],
                        "en":["Adverb: by default",'VP(V("perform"),Adv("well")).typ({perf:true})']},
        {"pattern":'.pos("pre")', "fr":["Adjectif:pré-posé",'NP(D("le"),A("bleu").pos("pre"),N("jouet"))'],
                           "en":["",'']},
        {"pattern":'.pos("post")', "fr":["Adjectif:postposé",'NP(D("le"),A("petit").pos("post"),N("jouet"))'],
                           "en":["",'']},
        {"pattern":'.pos("post")', "fr":["Adverbe:postposé",'VP(V("aller"),Adv("bien").pos("post")).t("pc")'],
                           "en":["Adverb: postpositive",'VP(V("perform"),Adv("well").pos("post")).typ({perf:true})']},
...
var sentType={"fr":'',"en":'',
    "ex": [
       ...
       {"pattern":".typ({exc:true})",
        ...
        {"pattern": ".typ({\"maje\":true})",
         "fr": ["Pluriel de majesté",
                  'S(Pro("moi").pe(1).g("f"),VP(V("être"),AP(A("gentil"),\n PP(P("avec"),NP(D("mon").pe(2),N("soeur")))))\n).typ({"maje":true})',],
         "en": ["Majestic plural",
                     'S(Pro("me").pe(1).c("nom"),\n VP(V("love"),NP(D("my").pe(1).ow("s").maje(false),N("mouse")))\n).typ({"maje":true})']},
         {"pattern": "( .maje(false)\n  ).typ({\"maje\":true})",
          "fr":["Pluriel de majesté, annulé localement pour <code>D</code> ou <code>Pro</code>",
            'S(Pro("moi").pe(1).g("f"),VP(V("être"),AP(A("gentil"),\n PP(P("avec"),NP(D("mon").pe(2).maje(false),N("soeur")))))\n).typ({"maje":true})'],
          "en":["Majestic plural, locally overridden for <code>D</code> or <code>Pro</code>",
            'S(Pro("me").pe(1).c("nom"),\n VP(V("love"),NP(D("my").pe(1).ow("s").maje(false),N("mouse")))\n).typ({"maje":true})'],
          },
...
var dateOption={"fr":"Formatage d'une date (défaut <code>.nat()</code>)",
    ...
    "ex":[
        {"pattern":'',      "fr":["en lettres, par défaut",'DT(new Date())'],
        ...
        {"pattern":'{nat:false}',
            "fr":["Affichage de l'heure et des minutes (en chiffres)",'DT().dOpt({year: false, month: false, date: false,\n  day: false, second: false, nat:false})'],
            "en":["Display hour and minutes as digits",'DT().dOpt({year: false, month: false, date: false,\n  day: false, second: false, nat:false})']},
        {"pattern":'{det:false}',
            "fr":["Non affichage du déterminant de la date",'DT(new Date()).dOpt({det: false})'],
            "en":["Do not display determiner",'DT(new Date()).dOpt({det: false})']},
        {"pattern":'{rtime:true}',
            "fr":["Date relative par rapport à aujourd'hui",'DT(new Date()).dOpt({rtime: true})'],
            "en":["Relative date compared with today",'DT(new Date()).dOpt({rtime: true})']},
        {"pattern":'{rtime:".." or Date}',
            "fr":["Date relative après une autre",'DT("2021/09/01").dOpt({rtime: "2021/08/27",\n hour:false,minute:false,second:false});'],
            "en":["Relative date after another one",'DT("2021/09/01").dOpt({rtime: "2021/08/27",\n hour:false,minute:false,second:false});']},
        {"pattern":'{rtime:".." or Date}',
            "fr":["Date relative avant une autre date",'DT("2021/09/01").dOpt({rtime: new Date("2021/09/10"),\n hour:false,minute:false,second:false});'],
...
var numberFormat={"fr":"Formatage d'un nombre","en":"Number formatting",
    "ex":[
        ...
        {"pattern":".nat()",    "fr":["nombre en toutes lettres",'NO("42").nat()'],
